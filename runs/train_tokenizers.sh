...
#html removed
python tokenizer_typer.py --input-file alltablesNotestSplitNohtml.txt --output-dir . --vocab-size 10000 --min-fz 3 --tokenizer-name alltablesNotestNohtml
python tokenizer_typer.py --input-file alltablesNotestSplitNohtml.txt --output-dir . --vocab-size 5000 --min-fz 3 --tokenizer-name alltablesNotestNohtml
python tokenizer_typer.py --input-file alltablesNotestSplitNohtml.txt --output-dir . --vocab-size 3000 --min-fz 3 --tokenizer-name alltablesNotestNohtml
